...
package net.mcreator.tempname.item;
...
public class LavaIngotItem extends TempNameModElements.ModElement {
	@ObjectHolder("temp_name:lava_ingot")
	public static final Item block = null;
	public LavaIngotItem(TempNameModElements instance) {
		super(instance, 6);
	}
